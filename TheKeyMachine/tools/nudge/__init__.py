...
class NudgeToolObject(ToolObject):
    ...
    TOOLS = {
        ...
        "nudge_left_all_keys": {"type": "tool", "label": "Nudge Left - All Keys", "icon": "nudge_left_all_keys", "callback": api.nudge_left_all_keys, "tooltip": TOOLTIPS["left_all"], "operation": _queued_nudge("all_keys", -1)},
        "nudge_left_scene": {"type": "tool", "label": "Nudge Left - Scene", "icon": "nudge_left_scene", "callback": api.nudge_left_scene, "tooltip": TOOLTIPS["left_scene"], "operation": _queued_nudge("scene", -1)},
        "nudge_right": {
        ...
        "nudge_right_all_keys": {"type": "tool", "label": "Nudge Right - All Keys", "icon": "nudge_right_all_keys", "callback": api.nudge_right_all_keys, "tooltip": TOOLTIPS["right_all"], "operation": _queued_nudge("all_keys", 1)},
        "nudge_right_scene": {"type": "tool", "label": "Nudge Right - Scene", "icon": "nudge_right_scene", "callback": api.nudge_right_scene, "tooltip": TOOLTIPS["right_scene"], "operation": _queued_nudge("scene", 1)},
        "nudge_insert_inbetween": {"type": "tool", "label": "Insert Inbetween", "icon": "nudge_insert_inbetween", "callback": api.nudge_insert_inbetween, "tooltip": TOOLTIPS["insert"], "operation": _queued_nudge("inbetween", 1)},
        "nudge_insert_inbetween_scene": {"type": "tool", "label": "Insert Inbetween - Scene", "icon": "nudge_insert_inbetween_scene", "callback": api.nudge_insert_inbetween_scene, "tooltip": TOOLTIPS["insert_scene"], "operation": _queued_nudge("inbetween_scene", 1)},
        "nudge_remove_inbetween": {"type": "tool", "label": "Remove Inbetween", "icon": "nudge_remove_inbetween", "callback": api.nudge_remove_inbetween, "tooltip": TOOLTIPS["remove"], "operation": _queued_nudge("inbetween", -1)},
        "nudge_remove_inbetween_scene": {"type": "tool", "label": "Remove Inbetween - Scene", "icon": "nudge_remove_inbetween_scene", "callback": api.nudge_remove_inbetween_scene, "tooltip": TOOLTIPS["remove_scene"], "operation": _queued_nudge("inbetween_scene", -1)},
    }
    SECTION = {
