...
class AnimationToolsToolObject(ToolObject):
    ...
    TOOLS = {
        ...
        "set_smart_key": {"type": "tool", "label": "Set Smart Key", "text": "S", "callback": api.set_smart_key, "tooltip": TOOLTIPS["smart_key"]},
        "set_smart_key_all_channels": {"type": "tool", "label": "Set Smart Key All Channels", "text": "S+", "callback": api.set_smart_key_all_channels, "tooltip": TOOLTIPS["smart_key_all"]},
