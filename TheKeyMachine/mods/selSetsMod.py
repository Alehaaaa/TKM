...
def add_button_selection(button_name):
    ...
    if button_name in button_selections:
        ...
        if runtime.get_modifier_mask() & 4:  # 4 representa la tecla Ctrl
...
def remove_button_selection(button_name):
    ...
    if button_name in button_selections:
        ...
        if runtime.get_modifier_mask() & 1:  # 1 representa la tecla Shift
...
def handle_button_selection(button_name):
    modifiers = runtime.get_modifier_mask()
