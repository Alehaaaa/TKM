...
if sys.version_info >= (3, 0):
    ...
    import TheKeyMachine.mods.animdataMod as animdataMod
else:
    import utilsMod as utilsMod
    import animdataMod as animdataMod
...
def interpolate_between(t):
    ...
    for curve_fn, key_group in animdataMod.curve_key_values.items():
