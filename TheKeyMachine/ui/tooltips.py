...
class QFlatTooltip(QtWidgets.QWidget):
    ...
    def __init__(
        ...
        QtWidgets.QWidget.__init__(self, parent if embedded else wutil.get_maya_qt())
    ...
    def _command_shortcut_text(self):
        ...
        try:
            ...
            return hotkeys.shortcut_for_command(self.command_id) or ""
        except Exception:
            return ""
    ...
    def _open_hotkey_editor(self):
        ...
        try:
            ...
            hotkeys.show_hotkeys_window_for_command(command_id)
        except Exception:
            pass
    ...
    def _add_to_shelf(self, header_title):
        ...
        try:
            ...
            shelf.create_tool_shelf_button(command_id, command_label, icon=command_icon)
        except Exception:
            pass
