...
from TheKeyMachine.ui.sliders.model import SliderMode
from TheKeyMachine.tools.sliders import session as slider_session
from TheKeyMachine.core import runtime
import TheKeyMachine.ui.widgets.timeline as timelineWidgets
from TheKeyMachine.data import icons
from TheKeyMachine.data.colors import COLORS

from TheKeyMachine.ui.tooltips import QFlatTooltipManager, format_tooltip_shortcut
...
class QFlatSliderWidget(cw.TooltipMixin, QtWidgets.QWidget):
    ...
    def setCurrentMode(self, identifier: str, temporary: bool = False):
        ...
        toolbar_widgets.build_slider_section) -- after that, a slider's own mode
    ...
    def _tooltip_command_metadata(self, value):
        ...
        if self._section_prefix:
            command_id = trigger.slider_command_name(
                self._section_prefix,
                mode.key,
                value,
            )
    ...
    def _start_slider_interaction(self, *, preview: bool):
        ...
        if self._sliderSession is None:
            if self._sessionFactory is None:
                self._sliderSession = slider_slider_session.SliderSession(
                    mode.key,
                    title=mode.label,
                    description=mode.description,
